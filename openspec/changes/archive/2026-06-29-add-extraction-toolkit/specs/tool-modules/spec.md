...
- **THEN** registered tool modules SHALL return sorted matches with confidence scores, including extraction matches before generic text cleanup when applicable.
