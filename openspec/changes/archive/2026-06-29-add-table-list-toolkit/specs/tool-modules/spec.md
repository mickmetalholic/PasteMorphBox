...
- **THEN** registered tool modules SHALL return sorted matches with confidence scores, including table/list matches before generic text cleanup when applicable.
